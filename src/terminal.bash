...
# 				input. For example, uses \x01 rather than \001 to avoid
# 				interpreting succeeding numerals as part of the
# 				preceding escape code.
#
# 				Terminal emulators are, at their core, a writhing mass of
# 				ancient	serpents and angry chaos.
#
# 				Bash quoting and string	manipulation and expansion are
# 				imperfect.  You get -i and -a types, and those are hints.
#
	...
	while (($# > 0)); do
		case "$1" in
			...
			gray | grey)
				...
				# If bright flag is set, output dim white.
		...
		for bbright in bdim bbright; do
			for fg in black red green yellow blue magenta cyan white; do
				for bright in dim bright; do
					mecho $bright $fg $bbright $bg text "#" nnl
				done
			done
		done
		echo
